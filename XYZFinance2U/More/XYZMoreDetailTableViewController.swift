    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        switch  tableSectionCellList[indexPath.section].cellList[indexPath.row] {
            ...
            case "credit":
                ...
                \("The foreign exchange rate is from https://exchangeratesapi.io".localized()) \(
                "It is a free service for current and historical foreign exchange rates published by the European Central Bank. Use it at your discretion.".localized())
